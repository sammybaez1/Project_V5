...
function book($flightID)
{
    ...
    query("Insert into customerFlights values(" . "'" . $_SESSION['JetRedUser'] . "'" . "," . "'" . $flightID . "');");
        ...
        <div class="container bg-light">
            <div id="SignInPrompt">
                ...
                if (isset($_SESSION['JetRedAdmin'])) {
                    ...
                    $result = query("SELECT * FROM flights WHERE airline='JetRed' and `arrivalTime`>'$currentDate'");
				...
				<td>" . "Status" . "</td>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $checkBooking = query("select * from customerFlights where user_id =" . "'" . $_SESSION['JetRedUser'] . "'" . " and flightID = " . "'" . $flightID . "'");
